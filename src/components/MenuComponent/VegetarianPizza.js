...
import { VegetarianList, vegToppings, crusts } from './MenuList'
    ...
    <>
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          ...
          <Grid item xs={6}>
            <Typography variant='h5' sx={{color:'orange'}} >Vegetarian Toppings:</Typography><br />
          ...
          <Button variant="contained" sx={{ marginLeft: '150px' }} endIcon={<AddShoppingCartOutlined />}>Add To Cart</Button>
        </DialogContent>
      </Dialog>
    </>
  )
